 ...
 * @author vipul
 */
public class HospitalAppointmentRequest extends WorkRequest{
    ...
    public HospitalAppointmentRequest() {
    }
    
    
    public HospitalAppointmentRequest(int id, String status, String userName, String hospitalName, Date date, LocalTime time) {
        super(id, status);
    ...
    public void setHospitalName(String dietitianName) {
        this.hospitalName = dietitianName;
    }
